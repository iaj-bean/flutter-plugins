        ...
        thread {
            try {
                val fitnessOptions = FitnessOptions.builder()
                        ...
                        .also { builder ->
                            when (dataType == DataType.TYPE_SLEEP_SEGMENT) {
                                true -> builder.accessSleepSessions(FitnessOptions.ACCESS_READ)
                            }
                        }
                        .build()
                ...
                activity.runOnUiThread {
                    result.success(null)
                    Log.i("FLUTTER_HEALTH::ERROR", e.message ?: "unknown error")
                    Log.i("FLUTTER_HEALTH::ERROR", e.stackTrace.toString())
                }
            }
        }
    }
